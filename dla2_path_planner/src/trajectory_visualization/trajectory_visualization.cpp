...
TrajectoryVisualization::TrajectoryVisualization(ros::NodeHandle &n, ros::NodeHandle &pn) {
    ...
    trajectory_raw_sub = n.subscribe<mav_planning_msgs::PolynomialTrajectory4D>(
                "/path_planner/planned_trajectory_raw", 10,
                &TrajectoryVisualization::trajectoryRawCallback, this);

    // ROS publishers
    rviz_markers_white_publisher = pn.advertise<visualization_msgs::Marker>("trajectory_markers", 10, true);
    rviz_markers_raw_white_publisher = pn.advertise<visualization_msgs::Marker>("trajectory_markers_raw", 10, true);

}

void TrajectoryVisualization::trajectoryRawCallback(const mav_planning_msgs::PolynomialTrajectory4D::ConstPtr &p_msg) {
    ...
    traj_points.ns = traj_edges.ns = "planned_trajectory_raw";
    ...
    //case WHITE:
    rviz_markers_raw_white_publisher.publish(p_traj_edges);
    rviz_markers_raw_white_publisher.publish(p_traj_points);
}
